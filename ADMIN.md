...
> **Важно:** После настройки любого нового курса нужно зачислить `seva@test.com` на этот курс (вручную через Admin → Подписки на курсы), чтобы была возможность проверить как всё выглядит у студента. Zoom-ссылку и код можно оставить пустыми — заполнить когда появятся.
