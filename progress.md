...
## Данные добавленные вручную (2026-02-26)

### Расписание МОШ 25/26 (11 занятий, март 2026)
Курс: "Интенсив к МОШ по истории 25/26" (`zenclass_id: 7dc97b81-9d45-4d95-9972-71a8c3d1da42`)
Занятия: 01–14 марта, время 10:00 МСК. Добавлены через `python -c` + Django ORM напрямую на сервере.

### Расписание Ломоносов 25/26 (20 занятий, март 2026)
Курс: "Интенсив к Ломоносов по истории 25/26" (`zenclass_id: 0a0668eb-0893-4e56-8111-28d4ff7ce3ee`, `id=99`)
Занятия: 02–22 марта (21.03 пустой), время 10:00 МСК.

### Дедлайны МОШ 25/26 (57 заданий)
57 домашних заданий из раздела "Теория в записи" курса МОШ.
Распределены по **2 дедлайна в день**, 01.03 → 29.03.2026, каждый до 23:59 МСК.
Логика: курс с вечным доступом, студент проходит в своём темпе — равномерное распределение.

### Тестовый студент seva@test.com зачислен на оба курса
`Enrollment` создан для МОШ 25/26 и Ломоносов 25/26, статус `active`.
